...
/**
 * Get formValues array from array of variable names and values
 *
 * @param projectSlug
 * @param environmentName
 * @param variables
 * @returns {promise|Object}
 */
helper.prototype.getFormValues = function (projectSlugOrId, environmentName, variables) {
	...
	// Load Environment, Build Variables, kick off release and deploy
	var createFormValuesPromise = variableSetPromise.then(function (variableSet) {
...
//		}
	...
	return createFormValuesPromise;
};
